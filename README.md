...
The authorized [Samsung SM-X400 / Android 16 transport passed](docs/test-plans/evidence/KR-003-SAMSUNG-TRANSPORT-CALIBRATION-2026-09-08.md). Three v1 calibrations remain INVALID at runner-side Accessibility verification; the [runner-v2 attempt](docs/test-plans/evidence/KR-003-SAMSUNG-HOST-EXCEPTION-2026-09-08.md) proved that correction passed, then stopped INVALID during the ARM host stage before any blocked hold. The [runner-v3 invocation](docs/test-plans/evidence/KR-003-SAMSUNG-RUNNER-V3-STARTUP-2026-09-08.md) then failed on a reserved PowerShell variable before any device command. The immutable [runner-v4 replacement](docs/test-plans/evidence/KR-003-SAMSUNG-CALIBRATION-V4-BUNDLE-2026-09-08.md) is prepared but Not run. No Samsung enforcement sample exists. The KR-003 qualification gate remains open.
