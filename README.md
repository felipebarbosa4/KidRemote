...
The authorized [Samsung SM-X400 / Android 16 transport passed](docs/test-plans/evidence/KR-003-SAMSUNG-TRANSPORT-CALIBRATION-2026-09-08.md). Three v1 calibrations remain INVALID at runner-side Accessibility verification; the [runner-v2 attempt](docs/test-plans/evidence/KR-003-SAMSUNG-HOST-EXCEPTION-2026-09-08.md) proved that correction passed, then stopped INVALID during the ARM host stage before any blocked hold. The [runner-v3 invocation](docs/test-plans/evidence/KR-003-SAMSUNG-RUNNER-V3-STARTUP-2026-09-08.md) then failed on a reserved PowerShell variable before any device command. Four independent [runner-v4 attempts](docs/test-plans/evidence/KR-003-SAMSUNG-RUNNER-V4-HOST-EXCEPTIONS-2026-09-08.md) passed permission/positive controls and issued ARM, then stopped on the same deterministic host variable-alias defect before attachment or blocked hold; cleanup succeeded each time. No Samsung enforcement sample exists. The KR-003 qualification gate remains open.
