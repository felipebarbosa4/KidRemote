...
- **Context:** The existing Mi 8 result is configuration-specific. This protocol subsequently produced a transport PASS on the exact Samsung SM-X400 / Android 16 API 36 / build `BP4A.251205.006` configuration; its later runner-v5 calibration separately passed while all earlier INVALID attempts remain unchanged.
