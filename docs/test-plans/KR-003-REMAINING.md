...
| AC-3 / TIME-04: 100 zero expiries | B,C,D | Samsung runner-v9 retained 100 automated active-oracle PASS rows (p95 317 ms) and checkpoints 1/2 PASS, then stopped checkpoint 3 `INVALID:SCREEN_OR_KEYGUARD`; runner-v10 adds reversible verified stay-awake orchestration. Q7 remains blocked on Mi 8 | One entirely fresh offline run must complete all 100 rows and all three checkpoints; the INVALID rows cannot be resumed, replaced or pooled |
