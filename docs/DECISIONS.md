...
**2026-09-08 KR-003 device status:** [shell input, UiAutomation and bounded Monkey were all denied on the Mi 8](test-plans/evidence/KR-003-MONKEY-DENIAL-2026-09-07.md), so OD-29's independent input prerequisite remains unmet there. On the exact Samsung configuration, transport passed and all earlier calibration INVALID records remain unchanged; the fresh [runner-v5 calibration passed](test-plans/evidence/KR-003-SAMSUNG-ORACLE-CALIBRATION-PASS-2026-09-08.md) its bounded active oracle and one owner agreement with verified cleanup. This permits only a configuration-bound bundle handoff. The 100 fresh offline cycles, remaining matrix, support decision and Play gate remain open; do not run automatically, change the Mi 8, reduce the gate or start KR-004.
