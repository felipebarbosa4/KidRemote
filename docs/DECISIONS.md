...
**2026-09-08 KR-003 device status:** [shell input, UiAutomation and bounded Monkey were all denied on the Mi 8](test-plans/evidence/KR-003-MONKEY-DENIAL-2026-09-07.md), so OD-29's independent input prerequisite remains unmet there. The exact [Samsung SM-X400 transport passed, then three v1 calibrations stopped INVALID](test-plans/evidence/KR-003-SAMSUNG-TRANSPORT-CALIBRATION-2026-09-08.md). Its [runner-v2 calibration](test-plans/evidence/KR-003-SAMSUNG-HOST-EXCEPTION-2026-09-08.md) passed permission verification and the positive fixture control, then stopped INVALID in ARM before the blocked hold. One typed-diagnostic calibration rerun is next; do not start 100 samples, change the Mi 8, reduce the gate or start KR-004.
