...
| [0008](0008-qualification-automation.md) | Debug qualification controls and observation oracle | Accepted for disposable KR-003 automation; device calibration pending |
