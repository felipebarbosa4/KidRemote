// Goal: produce an immutable Monkey transport preflight bundle from a clean source commit.
// Context: shell input is denied by the Mi 8; test the device Monkey touch class in a bounded shell process.
...
const mapping={'Test-KR003-MonkeyTransport.ps1':'tools/kr003/Test-KR003-MonkeyTransport.ps1','OracleTransport.psm1':'tools/kr003/OracleTransport.psm1','Qualification.psm1':'tools/kr003/Qualification.psm1','protocol.md':'docs/test-plans/KR-003-MONKEY-TRANSPORT.md','input-probe.apk':'spikes/android-enforcement/input-probe/build/outputs/apk/debug/input-probe-debug.apk','ordinary-fixture.apk':'spikes/android-enforcement/ordinary-fixture/build/outputs/apk/debug/ordinary-fixture-debug.apk'};
...
const manifest={schema:1,protocol:'KR003-MONKEY-TRANSPORT-PREFLIGHT',sourceCommit:commit,runnerVersion:1,diagnosticOnly:true,physicalExecution:'NOT_RUN',files,helperSha256:files.find(f=>f.name==='input-probe.apk').sha256,fixtureSha256:files.find(f=>f.name==='ordinary-fixture.apk').sha256,ownerDeviceClass:{model:'Xiaomi Mi 8',miui:'MIUI Global 12.0.3',api:29,codename:'dipper'}};
