// Goal: produce an immutable owner-run focused recovery task-reset calibration bundle from a clean source commit and verified builds.
...
const mapping = {
  ...
  "protocol.md": "docs/test-plans/KR-003-RECOVERY-TASK-RESET.md",
...
const manifest = {
  schema:1, protocol:"KR003-Q5-RECOVERY-TASK-RESET-CALIBRATION", sourceCommit:commit, runnerVersion:5, diagnosticOnly:true,
