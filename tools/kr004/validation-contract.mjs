...
export const requiredMigrations = ['202609110001_schema_rls.sql','202609110002_atomic_control.sql','202609110003_pairing.sql'];
export const requiredSuites = ['01_rls.test.sql','02_constraints.test.sql','03_atomic_control.test.sql','04_concurrent_control.test.sql','05_pairing.test.sql','06_pairing_races.test.sql'];
