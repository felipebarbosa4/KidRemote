...
try{
 ...
 Write-Output 'FROZEN_OWNER_MODULE_IMPORTS=17;ENTRYPOINT_PARSE=PASS;COMMANDS=19;ENROLL_CLOSURE=PASS;JOURNAL_CREATE_READ=PASS;DEVICE=NOT_INVOKED'
}finally{
