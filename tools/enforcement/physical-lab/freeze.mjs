...
const manifest={scope:'OD51_ONE_PERSISTENT_LAB_PRODUCT_SLICE',readiness:'READY_FOR_ONE_OWNER_RUN',source,ci:ci.databaseId,files,
 ...
 lease:{format:1,label:'org.kidremote.physical-lab',id:'kr-physical-<UUID>',state:'%LOCALAPPDATA%/KidRemote/physical-lab',secrets:'DPAPI current user + restricted ACL',onExit:'stop services; retain owned DB volume/identity',onReuse:'exact source/schema/device/artifact/permissions; no install or pairing'},
 journal:{format:'hash-chained fsync-before-admission events',originalVerdict:'immutable',cleanup:'independent',partial:'fail closed for review'},
